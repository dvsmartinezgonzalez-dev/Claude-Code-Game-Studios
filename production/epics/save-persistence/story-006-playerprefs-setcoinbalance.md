...
- [ ] `SetCoinBalance(int value)` — sets in-memory `economy.coin_balance = value`, marks dirty flag `true`, does NOT trigger a write directly; usable only after `IsReady = true`
