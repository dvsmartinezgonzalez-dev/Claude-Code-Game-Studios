...
namespace BoltSort.Visual
{
    ...
    public static class SkinCatalogue
    {
        ...
        private static readonly List<SkinItem> _balls = new()
        {
            ...
            new SkinItem { SkinId = "ball_birds", DisplayName = "Birds",
                           Category = SkinCategory.Balls, IsDefault = false, UnlockCost = 1000,
                           AssetFolder = "Birds/",
                           ThumbnailPath = "Sprites/Balls/Birds/ball_blue" },
            new SkinItem { SkinId = "ball_monsters", DisplayName = "Monsters",
                           Category = SkinCategory.Balls, IsDefault = false, UnlockCost = 1000,
                           AssetFolder = "Monsters/",
                           ThumbnailPath = "Sprites/Balls/Monsters/ball_blue" },
            new SkinItem { SkinId = "ball_liquid", DisplayName = "Liquid",
                           Category = SkinCategory.Balls, IsDefault = false, UnlockCost = 1000,
                           AssetFolder = "Liquid/",
                           ThumbnailPath = "Sprites/Balls/Liquid/ball_blue" },
            new SkinItem { SkinId = "ball_glow", DisplayName = "Glow",
                           Category = SkinCategory.Balls, IsDefault = false, UnlockCost = 1000,
                           AssetFolder = "Glow/",
                           ThumbnailPath = "Sprites/Balls/Glow/ball_blue" },
            new SkinItem { SkinId = "ball_rocks", DisplayName = "Rocks",
                           Category = SkinCategory.Balls, IsDefault = false, UnlockCost = 1000,
                           AssetFolder = "Rocks/",
                           ThumbnailPath = "Sprites/Balls/Rocks/ball_blue" },
        };
